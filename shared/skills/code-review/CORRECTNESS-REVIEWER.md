...
The task identifies a prepared review bundle containing the Git status and patch. Read that bundle first, then inspect the affected files and relevant callers, tests, types, and configuration directly from the repository.
