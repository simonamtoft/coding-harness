...
The task identifies a prepared review bundle containing the Git status and patch. Read that bundle first, then inspect affected files and relevant trust boundaries, callers, configuration, and tests directly from the repository.
